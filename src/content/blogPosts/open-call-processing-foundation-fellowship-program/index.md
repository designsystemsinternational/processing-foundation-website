---
title: "Open Call: Processing Foundation Fellowship Program"
subtitle: "**UPDATE: Application Deadline has been extended to Monday, May 15, 2023, 11:59 PM PST**"
slug: "open-call-processing-foundation-fellowship-program"
date: 2023-03-08T21:39:11.905Z
author:
  - "Processing Foundation"
category: "Fellowships"
indexImage: X9kkEOTfCSJpPpzH-pDX0A.webp
---
...
**Info Session:**  
[https://youtu.be/OG0p3szDQSs](https://youtu.be/OG0p3szDQSs)

**Info Session Slides:**  
[https://docs.google.com/presentation/d/1u5hVA6IMrg8FipsBn1EnduW-a80JGbtBo8cPOVCEesw/edit?usp=sharing](https://docs.google.com/presentation/d/1u5hVA6IMrg8FipsBn1EnduW-a80JGbtBo8cPOVCEesw/edit?usp=sharing)
...
For 2023, we will support five (5) (art/creative/technology) Fellows and three (3) Teaching Fellows with stipends, mentorship, and other public-facing opportunities. The number of Fellows this year has been expanded, thanks to the generous support and collaboration of [SOSO Limited](https://www.sosolimited.com/). We are additionally grateful for the support of [Bocoup](https://bocoup.com/) and our other outside mentors. And we continue to collaborate with the [College of Education & Human Development](https://education.gsu.edu/) at Georgia State University to sustain the work of past Teaching Fellowships. To learn more about the fellowship priority areas, stipends and guidelines, read on!
...
-   How can we translate accessibility guidelines across disciplines, for example, from [design patterns](https://w3c.github.io/aria-practices/) to art made using p5.js?
...
The application period opens **Wednesday, March 8, 2023 and closes Monday, May 15, 2023**. Selected fellows will be notified no later than the last week of May 2022. Late applications will not be accepted. Fellows will be selected by the Processing Foundation’s team and [Board of Directors](https://processingfoundation.org/people).
...
The Foundation is looking for potential funders who would be interested in sponsoring part or all of a fellow’s project. If you are interested in sponsoring a fellow for next year, contact Tsige Tafesse, Program Manager, at [tsige@processing.org](mailto:tsige@processing.org).
...
Beyond the priority areas, we welcome proposals that support specific needs and involve working with partners to build on past Fellowships. For example, projects extending the work of [Sierra Gilliam](https://medium.com/@ProcessingOrg/interactive-resource-guide-for-computer-science-teachers-9e236918b771)’s 2022 [project](https://sway.office.com/QkZAaq9RIQlUg3dC?ref=Link) using personal data and visualization to support culturally relevant computer science education will be generously supported by Georgia State University and mentor [Ben Shapiro](https://education.gsu.edu/profile/ben-shapiro/). Similarly, projects that extend the [Playful Teaching with p5.js](http://teach.angichau.com/) project will be mentored by [Angi Chau](https://www.linkedin.com/in/angichau) of the [Nueva School](https://www.nuevaschool.org/about/our-campuses/innovation-labs).
...
**Further questions?  
**Please contact [fellowship@processing.org](mailto:fellowship@processing.org)
