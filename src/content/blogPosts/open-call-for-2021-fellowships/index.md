---
title: "Open Call for 2021 Fellowships"
subtitle: "The Processing Foundation 2021 Fellowship Program is now accepting applications!"
slug: "open-call-for-2021-fellowships"
...
Application period is open March 1–April 9, 2021. Selected fellows will be notified by early May 2021. Late applications will not be accepted. Fellows will be selected by the Processing Foundation’s [Board of Directors and Board of Advisors](https://foundation.processing.org/people/).

[Apply here.](https://forms.gle/WxsK1MtGsk3xB89F6) If you have questions, please email [foundation@processing.org](mailto:foundation@processing.org).

The Foundation is looking for potential funders who would be interested in sponsoring part or all of a fellow’s project. If you are interested in sponsoring a fellow, contact Dorothy Santos, Executive Director, at [dorothy@processing.org](mailto:dorothy@processing.org)!

### **2021 Fellowship Guidelines**
...
Our past fellowships are good examples of work we believe is important, and of how those projects have evolved into self-sustaining projects in their own right. Applicants should familiarize themselves with [previous fellowship projects](http://foundation.processing.org/fellowships/) and read [our Medium’s series of articles](https://medium.com/processing-foundation/https-medium-com-tag-pf-fellowships-la/home) where past fellows describe, in their own words, what their fellowships entailed.
...
The applications must be submitted through [this Google Form](https://forms.gle/WxsK1MtGsk3xB89F6). Below is information about what is required. There are three sections to the application: 1) Personal Information, 2) Proposal, 3) Previous Projects

#### *Project Description*

The Project Description should be no more than 4000 characters. Accepted formats are .odt, .pdf, .docx, or .txt. The document should include responses to the following 6 questions:

1.  What you’re going to do. (If you’re applying for a Teaching Fellowship, please indicate this here.)
2.  How you’re going to do it and why you’re qualified for the work.
3.  Please select *at least one* Priority Area and describe how your project will address the concerns of this topic.
4.  The project’s expected results: Will your project produce a series of events, materials, products, etc.? Explain in detail.
5.  How your project will expand the possibilities of Processing, either through software, community, or both.
6.  How your project addresses the needs of a specific group, and how it will support the fostering of this community. Be specific about what challenges or needs this community has had presently and/or historically, and how your project will address those directly.

#### *Development document*

The Development Document should be no more than 2000 characters. Accepted formats are .odt, .pdf, .docx, or .txt. The document should include responses to the following 5 questions:
...
Please provide links to up to 3 of your previous projects, documented online (ex. vimeo, portfolio website, etc.)

#### *CV or Resume*

Your CV or resume should be no more than 2000 characters maximum. Accepted formats are .odt, .docx, .pdf, or .txt. Please include your GitHub account link in this document, if applicable.
