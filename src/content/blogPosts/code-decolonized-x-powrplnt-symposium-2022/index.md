---
title: "Code, Decolonized x POWRPLNT Symposium 2022"
subtitle: "New ways of learning and teaching programming languages for the web"
slug: "code-decolonized-x-powrplnt-symposium-2022"
...
[Code, Decolonized](https://docs.google.com/document/d/1BKmgg7zF4nuuMqGctO0OTIQmBxKO2OrvzYgvnSl2JD4/edit?usp=sharing) is a teaching practicum course offered at Parsons Design & Technology at the New School. Initiated by [shawné michaelain holloway](http://www.shawnemichaelainholloway.com/) and [Xin Xin](https://xin-xin.info/) in 2021, the project researches, experiments, and practices new ways of learning and teaching programming languages for the web through perspectives that are traditionally overlooked and under-recognized in the technical classroom.

In 2022, Xin Xin co-taught the spring semester course with new Code, Decolonized member Dejohn Huffman, who brings in a breadth of experience in community organizing and trauma-informed training. The course centers discussion of pedagogy from both theoretical and practical frameworks, and is structured to transition students into teaching roles. After receiving feedback from Processing Foundation mentors [Saber Khan](https://www.edsaber.info/), [Lauren Lee McCarthy](https://lauren-mccarthy.com/), [Dorothy R. Santos](https://dorothysantos.com/), and [Xiaowei R. Wang](https://www.xiaoweiwang.com/), Code, Decolonized students collaborated with [POWRPLNT](https://www.powrplnt.org/) to facilitate a two-day public symposium at Pioneer Work / Red Hook Labs at the end of April.
...
![](vPtOUMn_i0synwCa.webp)

*Sample slide from the Jump into Drawing with p5.js workshop, created by Aamina Palmer and Yiwen Xu*

### Resources

-   [Workshop Slideshow](https://docs.google.com/presentation/d/1Ataw4-3Ex_Ods4_lmqEpVv_6TJV-A901D8jxbPgjfsE/edit?usp=sharing)
-   [Workshop Documentation](https://decolonize.codes/blog/posts/1960244b-ee6a-4c64-b545-0de63c49360a)

### Facilitators’ Bios

![](s236ZBKATkNTkdt_.webp)
...
![](mqOuLr-fxr-j27r5.webp)

*Sample slide from the Let’s Learn about Variables and IF Statements! workshop, created by Gina Lee and Zoyah Shah.*

![](dG9jJNbNxldK8W2Y.webp)

*Sample slide from the Let’s Learn about Variables and IF Statements! workshop, created by Gina Lee and Zoyah Shah.*

### Resources

-   [Workshop Slideshow](https://docs.google.com/presentation/d/1x1s1bZ9_hqwWHsP_eVGgCmv-q98RmuW060N0LIvln2I/edit)
-   [Workshop Documentation](https://decolonize.codes/blog/posts/aea01ee4-ce73-4e26-a6b7-0b83251fbf10)

### Facilitators’ Bios

![](ZlMLwev4wCV8pv-b.webp)
...
> The workshop uses p5.zine ([demo](https://editor.p5js.org/munusshih/sketches/XVYsArvB2c)), a custom open-source tool to ease participants into learning functions (computer programming) and let everyone remix the zine template easily. This workshop welcomes everyone with different levels of coding knowledge.

![](gY7tDunGyBQL3QU4.webp)

*Sample slide from the GenZ(ine) workshop, created by Iley Cao and Munus Shih*

![](cI9Ae3HfM8uUUfkA.webp)

*A GenZ(ine) created by workshop participant and designer Theingi Thann*

### Resources

-   [p5.zine Demo](https://editor.p5js.org/munusshih/sketches/XVYsArvB2c)
-   [Workshop Slideshow](https://docs.google.com/presentation/d/1x1s1bZ9_hqwWHsP_eVGgCmv-q98RmuW060N0LIvln2I/edit)
-   [Workshop Documentation](https://www.notion.so/GenZ-ine-Project-b36caec04a95407494dd9cd2f9eb290c)

### Facilitators’ Bios

![](47eri_AOYyzVKM4t.webp)

*Munus Shih*

[Munus Shih](https://munusshih.com/) (he/him) is a Taiwanese-born designer that collaborates with contextual data and bespoke algorithms. With an interdisciplinary background in Design and Engineering, his works encompass interactive and customizable brand identities, campaigns, and user interfaces.

Aside from professional work, he is an active member of many creative coding and design communities. He dedicates to curating workshops, publishing articles, and hosting lectures based on the idea of design as a liberal art or cultural media through a decolonized and inclusive lens. You can find more about his teaching and community work [here](https://munusshih.github.io/).

![](h7orN8ZbA0XWq6Pp.webp)
...
![](S-1rw8tjPZINqZ6I.webp)

*Sample slide from the Mouse Paintbrush with p5.js workshop, created by tee topor and Sloane Dove.*

### Resources

-   [Workshop Slideshow](https://docs.google.com/presentation/d/1fYYHl614EQF5RJaSahZcCqRtLlEjNhmj7NKm0y9GYQQ/edit?usp=sharing)
-   [Workshop Documentation](https://tasty-dust-bf9.notion.site/mouse-paintbrush-with-p5-js-475a6f9b3c494a66b2ccc55983051067)

### Facilitators’ Bios

![](9t4iVp5P-6VmiLZb.webp)
...
![](Wji4vEibGV6cUO9.webp)

*Sample slide from the Visualizing Recurring Events with for Loops workshop, created by Jessica Jabr*

### Resources

-   [Workshop Slideshow](https://docs.google.com/presentation/d/1J0Rg5ZlT6QP5Adu9k-T46f-A4ArUtVyuaVJLv4nWKYs/edit?usp=sharing)
-   [Workshop p5 sketches](https://editor.p5js.org/fullmotion/collections/yZGM2KSdh)

### Facilitator’s Bio

![](IS9Cvu1TRDlU0tD_.webp)
...
![](mttEE8vtX84J90ms.webp)

*Nested for Loop and Permutation Design workshop held at the Code, Decolonized x POWRPLNT Symposium on Apr 23, 2022*

> This workshop introduces nested for loop in an accessible way for people new to coding. Using [Nested For Loop Visualization](https://editor.p5js.org/Mustard-Roy/full/QHkGnGqtx), a custom software made in p5.js, this workshop guides participants to understand the principles and execution process behind a computer programming concept that is conventionally challenging for beginners. Once participants get some practice with creating nested for loops, the workshop explores the concept of permutation design by inviting participants to create a table of logo variants.

![](aIEMFcWd5E7jMCyk.webp)

*A demo of the [Nested For Loop Visualization Software](https://editor.p5js.org/Mustard-Roy/full/QHkGnGqtx)*

![](lD9oZHJn4L73FChw.webp)

*Example of permutation design, created in p5.js by Roy Yang*

### Resources

-   [Nested For Loop Visualization Software](https://editor.p5js.org/Mustard-Roy/full/QHkGnGqtx)
-   [Workshop Slideshow](https://docs.google.com/presentation/d/1gcySt4Cj7uRxe69srLydJ6tz-Bc-QJCEtgd8UUtUm48/edit?usp=sharing)
-   [Workshop Documentation](https://decolonize.codes/blog/posts/0d99c24d-b9dc-4d76-8e4b-842fa27a752c)

### Facilitator’s Bio

![](VimGI1MhtGR3-KOT.webp)
...
-   [polyMorph Download Page](https://jaytobin.com/polymorph/)
-   [polyMorph Video Tutorial](https://www.youtube.com/watch?v=86p6qKNZBII)
-   [Workshop Slideshow](https://docs.google.com/presentation/d/1tRoSg5_XfzX5Qulo341keX_bban44Z21Q8Vuu2a293E/edit?usp=sharing)

### Facilitator’s Bio

![](Be9it32PSTGbwm8c.webp)

*Jay Tobin*

[Jay Tobin](https://jaytobin.com/) is a creative technologist and programmer from New York. An audiovisual artist, his work spans from live sets at Ars Electronica to custom music production software. His interest is in building community by lowering barriers of access in tech, and bringing people together by treating education as a conversation. He taught a course on [polyMorph](https://jaytobin.com/polymorph/), his custom-built generative music production app, during the 2022 Code, Decolonized Symposium.
