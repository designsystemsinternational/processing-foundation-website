...
![](F4Rj6ph9dL2y52tE.webp)

*Image Pixel Array Manipulation*

![](JszNBGPotsQPd5l9.webp)

*Circular Motion*

![](Fforjly9a_LPR4kE.webp)

*Monochromatic Color Scheme*

**Biography**

Malay Vasa is a third-year undergraduate student of Human Centered Design at Srishti Manipal Institute in Bangalore. He is also a self-taught front-end developer and creative coding enthusiast. He has been a part of the Processing community since one of his first-year projects was featured in the [p5.js 2020 showcase](https://connie-liu.me/p5.js-showcase/#/2020-All/project-15/). This is his first time participating in Google Summer of Code.
...
![](Cu-FZHr7CdrxPJ_N.webp)

Currently finishing this project as part of an extended timeline.

**Links**

-   [Work Product Report (Gist)](https://gist.github.com/aceslowman/3d18e8e3acac994bde2ae2512cc85f3d)
...
![](WOSoRM-xFPe71f9S.webp)

**Links**

-   [Wrap-up post](https://github.com/ShenpaiSharma/GSoC-2022-Wrap-Up)
-   [Multiple material PR](https://github.com/processing/p5.js/pull/5774)
-   [Rounded rect PR](https://github.com/processing/p5.js/pull/5789)
...
![](UDlpNxLsAtIPCHgW.webp)

**Links**

-   [Creative Machine GitHub](https://github.com/jjeongin/creative-machine)
-   [Creative Machine Website](https://jjeongin.github.io/creative-machine)

![](twfdSifgfzOa1fLQ.webp)
...
![](8QXhwcRwNBN0p6V8.webp)

*Creative Machine Website demo gif.*

**Project Description**

Creative Machine is a Machine Learning library for Processing. The library was implemented on top of [Deep Java Library (DJL)](https://djl.ai/) and currently supports five machine learning models: object detector, image classifier, pose detector, face detector, and sentiment analyzer. The models can run predictions on an image or video in a Processing application. The [library website](https://jjeongin.github.io/creative-machine) offers documentation of each model with example codes.
...
![](Bjux9Ribs4dU_5bo.webp)

**Links**

-   Article: [GIF encoding in p5.js](https://www.jesirgb.com/blog/gif-encoding)
-   Github PR: [Implement saveGif as a native p5 function #5709](https://github.com/processing/p5.js/pull/5709)
...
#### [Tushar Gupta](https://www.linkedin.com/in/tushar55/) — Add Skia as a 2D renderer in p5.py

Mentored by [Ziyao Zhang (Mark)](https://www.linkedin.com/in/ziyaointl/), past GSoC contributor

![](yQGVtI5Qa8z_JzIr.webp)

**Links**

-   [Medium Article](https://medium.com/@codingid6/implementing-a-2d-backend-renderer-using-skia-for-p5py-c20ae2dfdf7b)
-   [GitHub Work Product Report](https://github.com/p5py/p5/blob/master/project-wrapups/summer-fellow-2022-wrapup/tushar-processing-summer-fellow-2022-product-work-report.md)
...
-   [All other minor Pull Requests that fixed other minor stuff](https://github.com/p5py/p5/pulls?q=is%3Apr+is%3Aclosed+author%3Atushar5526)
...
I have written an in depth [article](https://medium.com/@codingid6/implementing-a-2d-backend-renderer-using-skia-for-p5py-c20ae2dfdf7b) about the same as well.
...
![](CWlg8zjAJZxOjwy3.webp)

Currently finishing this project as part of an extended timeline.

**Links**

All my contributions during the mentorship program can be found [here](https://github.com/processing/processing-android/pulls?q=is%3Apr+author%3Arupeshkumar22).
