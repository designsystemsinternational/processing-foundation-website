...
Our mentors included longtime contributors to our software, members of our Board, and current fellows and fellowship alumni. Their expertise was essential to GSoC being a success and deepening the connections and sharing of knowledge which is so important to making open source sustainable. The mentors were Alice Chung, [Andres Colubri](http://andrescolubri.net/), [Casey Reas](https://users.dma.ucla.edu/~reas/), [Cassie Tarakajian](https://cassietarakajian.com/), [Daniel Shiffman](https://shiffman.net/), [Elie Zananiri](http://prisonerjohn.com/), Evelyn Masso, [Gottfried Haider](https://ghai.xyz/), Jason Sigal, Jesus Duran, [Kate Hollenbach](http://www.katehollenbach.com/), [Lee Tusman](http://leetusman.com), Manindra Moharana, [Rupak Das](https://github.com/rupak0577), [Saber Khan](https://www.edsaber.info/), [Sara Di Bartolomeo](https://picorana.github.io/), and Stalgia Grigg.

![](SiQyB6P3ipaApCvonpImBQ.webp)
...
Student**:** [Abhik Pal](https://github.com/abhikpal/)

Mentor**:** Manindra Moharana

[Work report](https://p5.readthedocs.io/en/latest/releasenotes/0.5.0.html)

[Repository](https://github.com/p5py/p5)
...
[Work Report](https://manavmjjain.wixsite.com/home/blog-1/gsoc-18-final-evaluation)

[Repository](https://github.com/manav-mj/processing-android)

![](RGlenKlROjeBe5oO.webp)
...
Student: [Adil Rabbani](https://adilrabbani.github.io/)

Mentor: Stalgia Grigg

[Medium Article](https://medium.com/processing-foundation/gsoc-2018-my-summer-with-processing-foundation-5e5904e816fa)
...
Student: [Kevin Stadler](https://kevinstadler.github.io)
...
![](ULj_xVKTfCUWebC2.webp)

[Kevin Stadler](https://kevinstadler.github.io) successfully undertook a complete rewrite of [Processing’s Sound library](https://github.com/processing/processing-sound). While his fully backwards-compatible re-implementation based on a Java synthesis engine greatly improved Processing Sound support for platforms such as Android and Raspberry Pi, the library’s example sketches also received a complete overhaul, with an eye on making library usage even easier for beginners.

![](PSjH1IyPhPcJaFlN.webp)
...
Student: [Maksim Surguy](https://twitter.com/msurguy?lang=en)

Mentor: [Gottfried Haider](https://ghai.xyz/)
...
[Repository 1](https://www.github.com/jaewhyun/GettingStarted), [repository 2](https://www.github.com/jaewhyun/ReferenceTool)

![](gnEVHpQtP2IqFs5b.webp)
...
Student Name: [Chan Jun Shern](https://junshern.github.io/)
...
To encourage the use of these features and resources we’ve built for algorithmic composition, the project culminates in an [online tutorial](https://junshern.github.io/algorithmic-music-tutorial/) that walks through a number of examples and best practices for algorithmic composition on p5.js-sound.

![](hy_0kN9lNSgjjQ9M.webp)
...
Student: [Tanvi Kumar](https://github.com/TanviKumar)
...
![](x1w1Jmr8ID_DP7oa.webp)

*Liang Tang*

My project for this summer was to integrate a new console to p5.js web editor. The two main tasks that I focused on were:

1.  Improve the original console in p5.js web editor. I implemented the following features to the console:
...
![](p6xor-5upB-UBPCY.webp)

*\[image description: A screenshot that includes part of the p5.js browser. At the top, in hot pink text, is a menu that reads, “p5.js: Download \* Start \* Reference \* Libraries \* Learn \* Community. en | es | fr.” In the center is video a person with an graphic of scattered lines in a band of color; the caption at the bottom of the video reads, “I made this with p5js”. On the bottom of the image is white background, with a portion of a large, hot pink asterisk in the lower right corner.\]*

![](dOo_dZt6Hiyny39.webp)

*\[image description: A screenshot that includes part of the p5.js browser. At the top, in hot pink text, is a menu that reads, “p5.js: Download \* Start \* Reference \* Libraries \* Learn \* Community. en | es | fr.” In the center is video a person with rainbow lines curving upward; the caption at the bottom of the video reads, “Your imagination is the limit!” On the bottom of the image is white background, with a portion of a large, hot pink asterisk in the lower right corner.\]*
